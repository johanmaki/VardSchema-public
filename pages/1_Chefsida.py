...
def generate_schedule(employees: list[tuple]) -> None:
    ...
    failed_days = {}
    for day in dates:
        available_day = new_staff.copy()  # Alla anställda är tillgängliga varje dag
        shifts = daily_shifts[day]
        res = assign_shifts_for_day(day, shifts, available_day, new_staff, emp_state, min_exp_req)
        if res is None:
            ...
            with st.form(key="edit_employee"):
                ...
                if st.form_submit_button("💾 Spara ändringar"):
                    ...
                    try:
                        ...
                        # Ta bort st.experimental_rerun() om den inte finns
                    except Exception as e:
